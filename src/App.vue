  ...
  methods: {
    ...
    getAwardAndReport(){
      ...
      if(data){
        ...
        this.$store.commit('SET_AWARD',listAward.filter(la => !la.status).length);
...
<style>
 ...
 .box-shadow{
  ...
  .table-wrapper-scroll-y {
    ...
    .odometer.slow.odometer-animating-up .odometer-ribbon-inner, .odometer.odometer-animating-down.odometer-animating .odometer-ribbon-inner {
   ...
   .odometer.normal.odometer-animating-up .odometer-ribbon-inner, .odometer.odometer-animating-down.odometer-animating .odometer-ribbon-inner {
  ...
  .odometer.fast.odometer-animating-up .odometer-ribbon-inner, .odometer.odometer-animating-down.odometer-animating .odometer-ribbon-inner {
