                ...
                <table class="table table-borderless bg-white rounded">
                    <tbody>
                        ...
                        <td >
                            ...
                            <!-- <a href="javascript:void(0)" @click="report(n.name,n.amount,n.lucky)" class="ml-2">{{n.name}}</a> -->
                        </td>
...
export default {
    ...
    methods:{
        ...
        toExcel(name,amount,listuser){
            this.title = ['รายชื่อผู้ที่ได้รับรางวัล',"รางวัล "+name,"จำนวน "+amount]
        ...
        report(name,amount,listuser) {
            ...
            content: [{
                ...
                {
                    width: 'auto',
                    text: 'รายชื่อผู้ที่ได้รับรางวัล '+name+' จำนวนรางวัล '+amount+' รางวัล',
                    fontSize: 24,
                    bold: true,
                    style: "lineSpacing"
